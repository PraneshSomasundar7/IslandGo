      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 pb-12 sm:pb-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mb-12 sm:mb-16">
            <div className="px-4 sm:px-6 py-2 sm:py-3 bg-white/80 backdrop-blur-md rounded-full border border-amber-200 shadow-sm hover:bg-white hover:border-amber-300 hover:shadow-md transition-all duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-6xl mx-auto mb-12 sm:mb-20">
          ...
          <Link 
            ...
            className="group relative overflow-hidden bg-white/80 backdrop-blur-lg rounded-xl sm:rounded-2xl border border-amber-200 shadow-sm p-6 sm:p-8 hover:bg-white hover:border-[#FF6B35] hover:shadow-lg transition-all duration-300 hover:scale-[1.02]"
          >
            ...
            <div className="relative z-10">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-[#FF6B35]/10 flex items-center justify-center mb-4 sm:mb-6 group-hover:bg-[#FF6B35]/20 transition-colors duration-300">
                <Users className="w-6 h-6 sm:w-7 sm:h-7 text-[#FF6B35]" />
              </div>
          ...
          <Link 
            href="/content-gaps"
            className="group relative overflow-hidden bg-white/80 backdrop-blur-lg rounded-xl sm:rounded-2xl border border-amber-200 shadow-sm p-6 sm:p-8 hover:bg-white hover:border-[#4ECB71] hover:shadow-lg transition-all duration-300 hover:scale-[1.02]"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-[#4ECB71]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            <div className="relative z-10">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-[#4ECB71]/10 flex items-center justify-center mb-4 sm:mb-6 group-hover:bg-[#4ECB71]/20 transition-colors duration-300">
                <MapPin className="w-6 h-6 sm:w-7 sm:h-7 text-[#4ECB71]" />
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 sm:mb-3">
          ...
          <Link 
            href="/viral-content"
            className="group relative overflow-hidden bg-white/80 backdrop-blur-lg rounded-xl sm:rounded-2xl border border-amber-200 shadow-sm p-6 sm:p-8 hover:bg-white hover:border-[#00D4FF] hover:shadow-lg transition-all duration-300 hover:scale-[1.02]"
          >
            ...
            <div className="relative z-10">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-[#00D4FF]/10 flex items-center justify-center mb-4 sm:mb-6 group-hover:bg-[#00D4FF]/20 transition-colors duration-300">
                <Sparkles className="w-6 h-6 sm:w-7 sm:h-7 text-[#00D4FF]" />
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 sm:mb-3">
